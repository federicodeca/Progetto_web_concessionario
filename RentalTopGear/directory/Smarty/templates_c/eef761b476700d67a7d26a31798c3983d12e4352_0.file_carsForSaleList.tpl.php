<?php
/* Smarty version 5.5.1, created on 2025-07-02 18:15:58
  from 'file:carsForSaleList.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_68655b3e9d71b8_69769229',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'eef761b476700d67a7d26a31798c3983d12e4352' => 
    array (
...
function content_68655b3e9d71b8_69769229 (\Smarty\Template $_smarty_tpl) {
...
>
  ...
  <input type="hidden" id="actualMethod" value="showCarsForSale/<?php echo (($tmp = $_smarty_tpl->getValue('currentPage') ?? null)===null||$tmp==='' ? 1 ?? null : $tmp);?>
">
...
?>
      ...
      <div class="col-md-4">
        <a href='/RentalTopGear/User/selectCarForSale/<?php echo $_smarty_tpl->getValue('car')->getIdAuto();?>
'>
        ...
        <div class="row justify-content-center">
          ...
          <nav aria-label="Pagination">
            <ul class="pagination">
                ...
                <li class="page-item"> 
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/<?php echo $_smarty_tpl->getValue('currentPage')-1;?>
">Previous</a>
                </li>
              <?php } else { ?>
              ...
              <?php if ($_smarty_tpl->getValue('prevPage') >= 1) {?>
                <li class="page-item">
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/<?php echo $_smarty_tpl->getValue('prevPage');?>
"><?php echo $_smarty_tpl->getValue('prevPage');?>
              ...
              <li class="page-item active " aria-current="page">
                <a class="page-link" href="/RentalTopGear/User/showCarsForSale/<?php echo $_smarty_tpl->getValue('currentPage');?>
"><?php echo $_smarty_tpl->getValue('currentPage');?>
              ...
              <?php if ($_smarty_tpl->getValue('nextPage') <= $_smarty_tpl->getValue('totalPages')) {?>
                <li class="page-item">
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/<?php echo $_smarty_tpl->getValue('nextPage');?>
