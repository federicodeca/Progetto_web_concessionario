<?php
/* Smarty version 5.5.1, created on 2025-06-26 22:03:27
  from 'file:carDetailsSale.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_685da78f930c43_09716150',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dc16933eb29a9e53faa0839068a13316a0af0e35' => 
    array (
...
function content_685da78f930c43_09716150 (\Smarty\Template $_smarty_tpl) {
          ...
          <div class="col-md-4">
              <div class="left-content">
                ...
                <p>seguici sulle nostre pagine social per rimanere aggiornato sulle novità e per ricevere sconti</p>
                                 <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('car')->getPhoto(), 'photo', false, NULL, 'foto', array (
  'iteration' => true,
));
$foreach0DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('photo')->value) {
$foreach0DoElse = false;
$_smarty_tpl->tpl_vars['__smarty_foreach_foto']->value['iteration']++;
?>
          <p>Foto <?php echo ($_smarty_tpl->getValue('__smarty_foreach_foto')['iteration'] ?? null);?>
 - Type: <?php echo $_smarty_tpl->getValue('photo')->getType();?>
 - Encoded: <?php echo strlen((string) $_smarty_tpl->getValue('photo')->getEncodedData());?>
</p>
        <?php
}
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="contact-form">
              <form action="RentalTopGear/User/loginAndCreditRequirementSale" id="modal-contact">
                  <div class="row">
                       <div class="col-md-6">
                          <fieldset>
