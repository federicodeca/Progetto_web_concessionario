...
<div class="products">
  <div class="container">
    ...
    {foreach $filteredCars as $car}
      ...
      <div class="col-md-4">
        <a href='/RentalTopGear/User/selectCarForSale/{$car->getIdAuto()}'>
        ...
        <div class="row justify-content-center">
          ...
          <nav aria-label="Pagination">
            <ul class="pagination">
              ...
              {if $currentPage > 1} 
                <li class="page-item"> 
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/{$currentPage - 1}">Previous</a>
                </li>
              {else}
              ...
              {if $prevPage >= 1}
                <li class="page-item">
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/{$prevPage}">{$prevPage}</a>
                </li>
              {/if}

              <li class="page-item active " aria-current="page">
                <a class="page-link" href="/RentalTopGear/User/showCarsForSale/{$currentPage}">{$currentPage}</a>
              </li>

              {if $nextPage <= $totalPages}
                <li class="page-item">
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/{$nextPage}">{$nextPage}</a>
                </li>
              {/if}
              ...
              {if $currentPage < $totalPages}
                <li class="page-item">
                  <a class="page-link" href="/RentalTopGear/User/showCarsForSale/{$currentPage + 1}">Next</a>
                </li>
              {else}
                <li class="page-item disabled">
