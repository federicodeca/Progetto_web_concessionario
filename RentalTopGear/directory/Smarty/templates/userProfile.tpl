        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"> <div id="login-box" ></div> </li>
            </ul>
          </div>
        </div>
      </nav>
        ...
        <div class="row">
          <div class="col-md-10 ">
            ...
            <div class="card-body">
              ...
              <h4 class="mb-3 ml-3" style="color:white">Name: {$user->getFirstname()}</h4> 
              <h4 class="mb-3 ml-3" style="color:white">Surname: {$user->getLastname()}</h4>
              <h4 class="mb-3 ml-3" style="color:white">License: {if $user->getIsVerified()}inserita{else}non inserita{/if}</h4>
              <h4 class="mb-3 ml-3" style="color:white">Phone Number: {$user->getPhone()}</h4>
              <h4 class="mb-3 ml-3" style="color:white">Address: {$user->getAddress()}</h4>
              <h4 class="mb-3 ml-3" style="color:white">City: {$user->getCity()}</h4>

              <button class="btn btn-primary px-4 mb-4" style="color:aliceblue; margin-top: 20px;" data-toggle="modal" data-target="#passwordModal">Change Password</button>. <!-- data target= id del modal-->
