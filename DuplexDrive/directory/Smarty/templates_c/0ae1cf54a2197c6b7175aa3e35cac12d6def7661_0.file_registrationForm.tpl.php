  ...
  <body>
    ...
    <div class="services" style="background-image: url(/DuplexDrive/directory/Smarty/assets/images/other-image-fullscren-1-1920x900.jpg);">
      <div class="container" style="width:auto; height: auto; padding: 20px; margin-top: 100px;">
           <form  method="post" action="/DuplexDrive/User/registration">
          ...
          <div class="form-row">
            <div class="col-md-6" style="margin-top: 20px;">
             ...
             <div class="col-md-6" style="margin-top: 20px;" >
              ...
              <input type="text" class="form-control" id="inputAddress" name="username" required ="">
            </div>
          </div>  
          ...
          <div class="form-row">
            <div class="col-md-6" style="margin-top: 20px;">
              ...
              <input type="text" class="form-control" id="namePhone" name="phone" required ="">
            </div>
