<?php
/* Smarty version 5.5.1, created on 2025-07-05 15:49:01
  from 'file:adminRentCars.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_68692d4d806866_93184017',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '76d710ffdb54f62a6447814c183d11f2d04734b5' => 
    array (
      0 => 'adminRentCars.tpl',
      1 => 1751717372,
      2 => 'file',
...
function content_68692d4d806866_93184017 (\Smarty\Template $_smarty_tpl) {
...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="/DuplexDrive/directory/Smarty/assets/css/owl.css">
     ...
     <?php echo '<script'; ?>
 src="/DuplexDrive/directory/Smarty/js/alert-data-logic.js"><?php echo '</script'; ?>
>
...
">
    ...
    <div class="container my-5">
      ...
      <form  method="post" action="/DuplexDrive/Admin/showUnavailabilities" enctype="multipart/form-data">
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
      ...
      <?php if ((true && ($_smarty_tpl->hasVariable('unavailabilities') && null !== ($_smarty_tpl->getValue('unavailabilities') ?? null)))) {?>
        <div class="mt-5">
          ...
          <div style="max-height: 300px; overflow-y: auto;">
            <table class="table table-sm table-bordered table-striped bg-white">
              ...
              <tbody>
                <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('unavailabilities'), 'unavailability');
$foreach1DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('unavailability')->value) {
$foreach1DoElse = false;
?>
                  <tr>
                    <td><?php echo $_smarty_tpl->getValue('unavailability')->getStart()->format("d-m-y");?>
</td>
                    <td><?php echo $_smarty_tpl->getValue('unavailability')->getEnd()->format("d-m-y");?>
</td>
                    <td>
                      <a href="/DuplexDrive/Admin/deleteUnavailability/<?php echo $_smarty_tpl->getValue('unavailability')->getIdUnav();?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
         ...
         <form method="post" action="/DuplexDrive/Admin/insertUnavailability" enctype="multipart/form-data" class="mt-4">
          <div class="form-row">
