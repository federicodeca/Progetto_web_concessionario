...
<body>
      ...
      <script src="/DuplexDrive/directory/Smarty/js/date-selector-chart.js"></script>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a class="nav-link active" href="/DuplexDrive/Owner/showRentStatsForPeriod/">Statistiche noleggi</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  <div class="section-heading">
                    ...
                    <div class="row">
                      <form method="post" action="/DuplexDrive/Owner/getRentStatsForPeriod" >
                        <div class="col-md-12">
